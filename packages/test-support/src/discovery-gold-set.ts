...
export interface DiscoveryGoldCase {
  ...
  expected:
    ...
    | { kind: "FORMALIZATION_CANDIDATE"; recommendedKind?: "TASK" | "MINI_PROJECT" | "PROJECT" | "UNRESOLVED"; expectedMaturity?: "KEEP_OBSERVING" | "READY_FOR_DECISION" };
}
...
export const DISCOVERY_GOLD_SET: DiscoveryGoldCase[] = [
  ...
  { id: "B01", content: "发布前逐项确认检查清单，以后每次发布都要用", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "KEEP_OBSERVING" } },
  { id: "B02", content: "正式启动数据库高可用演练，需要完成环境准备、SOP、切换验证，最后交付演练报告", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "READY_FOR_DECISION" } },
  { id: "B03", content: "采购规格书需要多天整理，完成后形成一版可复用文档", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "MINI_PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
  { id: "B04", content: "跨三个季度的新长期方向，涉及多个独立成果，值得单独跟踪", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
  ...
  { id: "E01", content: "正式启动发布检查清单维护，需要完成 A、B、C，最后交付清单文档", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "READY_FOR_DECISION" } },
  { id: "E02", content: "数据库高可用演练这个方向会跨多天，有 SOP 和切换验证两个交付", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "MINI_PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
  { id: "E03", content: "建立跨三个独立方向的长期项目，各方向都有自己的成果", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
  ...
  { id: "E06", content: "TODO 持续整理发布检查清单", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "KEEP_OBSERVING" } },
  { id: "E07", content: "TODO 采购规格书要形成可复用文档", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "MINI_PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
  { id: "E08", content: "这是一段纯背景说明，没有任何行动", expected: { kind: "NO_CANDIDATE", reason: "REFERENCE_ONLY" } },
  { id: "E09", content: "明天继续整理发布检查清单", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "KEEP_OBSERVING" } },
  ...
  { id: "F07", content: "正式启动发布检查清单维护，明确交付清单文档", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "TASK", expectedMaturity: "READY_FOR_DECISION" } },
  { id: "F08", content: "采购规格书整理形成可复用文档，跨多天", expected: { kind: "FORMALIZATION_CANDIDATE", recommendedKind: "MINI_PROJECT", expectedMaturity: "KEEP_OBSERVING" } },
