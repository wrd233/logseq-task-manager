...
export class KernelClient {
  ...
  runDiscovery(scope: DiscoveryScope): Promise<{ run: DiscoveryRun }> { return this.#request("POST", "/v1/discovery/run", { scope }); }
