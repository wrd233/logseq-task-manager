...
export class KernelClient {
  ...
  upsertGovernanceIssue(input: { id?: string; workObjectId: string; dimension: string; type: GovernanceIssue["type"]; summary: string; evidenceIds?: readonly string[]; sourceSnapshotId: string; formalVersion: number; correlationId?: string | null }): Promise<{ issue: GovernanceIssue }> { return this.#request("POST", "/v1/issues", input); }
