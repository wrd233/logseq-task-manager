...
function record(): ServiceStoredProposal {
  ...
  return { updatedAt: "2026-07-20T12:01:00.000Z", files: { proposalMd: "# 正式化", proposalJson: "{}" }, proposal: {
    ...
    groups: [{ groupId: "formalize", explanation: "不可拆", risk: "MEDIUM", independentlyAcceptable: true, dependencies: [], textPatches: [{ blockUuid: "block-commit", beforeText: before, afterText: after, beforeHash: checksum(before), afterHash: checksum(after) }], semanticOperations: [{ operationId: "create", kind: "CREATE_OBJECT", target: { kind: "BLOCK", id: "block-commit", version: 1, hash: checksum(before) }, summary: "创建 Task", payload: { objectType: "TASK", text: "核对告警" }, preconditions: [] }], disposition: "ACCEPTED" }], status: "ACCEPTED", createdAt: "2026-07-20T12:00:00.000Z",
  } };
}
