...
export type ServiceRuntimeClient = Pick<LocalServiceClient, "health" | "listAssociations" | "listPrimaryOwnerships" | "addAssociation" | "listCandidates" | "discoverCandidate" | "setCandidateDisposition" | "formalizeCandidate" | "updateCandidate" | "synchronizeExplicitObject" | "listObjects" | "createMiniProjectClosureProposal" | "draftMiniProjectClosure" | "listPrimaryAnchors" | "observePrimaryAnchor" | "rebindPrimaryAnchor" | "prepareProject" | "finalizeProject" | "nowWork" | "selectFocus" | "removeFocus" | "reorderFocus" | "changeCondition" | "changeDeadline" | "listProposals" | "submitProposal" | "generateProposal" | "reviewProposal" | "revalidateProposal" | "prepareProposalCommit" | "finalizeProposalCommit" | "compensateProposalCommit" | "commitProjectClosure" | "commitLifecycleTransition" | "commitPrimaryOwnership" | "undoPrimaryOwnership" | "listSemanticCommits" | "prepareProposalUndo" | "finalizeProposalUndo" | "compensateProposalUndo" | "listMigrationRuns">;
