...
export type ServiceRuntimeClient = Pick<LocalServiceClient, "health" | "listAssociations" | "listPrimaryOwnerships" | "addAssociation" | "listCandidates" | "discoverCandidate" | "setCandidateDisposition" | "formalizeCandidate" | "updateCandidate" | "synchronizeExplicitObject" | "listObjects" | "createMiniProjectClosureProposal" | "createLifecycleProposal" | "draftMiniProjectClosure" | "listPrimaryAnchors" | "observePrimaryAnchor" | "rebindPrimaryAnchor" | "prepareProject" | "finalizeProject" | "nowWork" | "selectFocus" | "removeFocus" | "reorderFocus" | "changeCondition" | "changeDeadline" | "listProposals" | "submitProposal" | "generateProposal" | "reviewProposal" | "revalidateProposal" | "prepareProposalCommit" | "finalizeProposalCommit" | "compensateProposalCommit" | "commitProjectClosure" | "commitLifecycleTransition" | "commitPrimaryOwnership" | "undoPrimaryOwnership" | "undoLifecycle" | "listSemanticCommits" | "prepareProposalUndo" | "finalizeProposalUndo" | "compensateProposalUndo" | "listMigrationRuns">
  & Partial<Pick<LocalServiceClient, "claimGraphReadRequest" | "completeGraphReadRequest">>;
