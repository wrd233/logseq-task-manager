          ...
          : model.workspace === "review"
            ...
            : model.workspace === "reentry"
              ...
              : model.workspace === "governance"
                ? renderAgentGovernance(model.agentGovernance ?? { status: "loading", mode: "EXPERIMENT", automaticWritesPaused: true, globalWritesPaused: false, decisionFilter: "ALL", decisionSearch: "", decisions: [], rules: [], signals: [], events: [], selectedDecisionIds: [], now: new Date().toISOString() })
