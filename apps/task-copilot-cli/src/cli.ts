...
export async function runCli(argv: string[], client: Pick<KernelClient, "status" | "listObjects" | "showObject" | "showCommit" | "listRecovery" | "showEvidence" | "showAgentRun" | "showProposal" | "listFeedback">, io: CliIO): Promise<number> {
  ...
  try {
    ...
    else { io.err("Usage: task-copilot status|object list|object show <id>|commit show <id>|recovery list|evidence show <id>|agent-run show <id>|proposal show <id>|feedback list [--json]"); return 2; }
