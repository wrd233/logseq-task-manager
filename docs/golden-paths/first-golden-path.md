...
1. Logseq loaded the local `Task Copilot vNext 0.2.0` plugin and showed `Task Copilot vNext 已就绪。`. A fresh Desktop reload registered the vNext commands through the host SDK; Phase 3 adds the explicit Agent current-focus command.
