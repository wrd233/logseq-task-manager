...
| CS-07 | Stable Logseq-style Draft Tree and user-edit protection | model vocabulary only | pending | IN_PROGRESS |
...
| CS-11 | Existing flow and governance regressions | root check pending | pending | IN_PROGRESS |
