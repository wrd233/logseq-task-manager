...
| CS-11 | Existing flow and governance regressions | Node 20 root `./scripts/check.sh` passes at CS-CP04; legacy Grill compatibility entries and Plugin UI suite pass (517/517 at CS-CP06); Local Service 198/198 | pending | IN_PROGRESS |
