...
| CS-11 | Existing flow and governance regressions | Node 20 root `./scripts/check.sh` passes at CS-CP04; legacy Grill compatibility entries and Plugin UI suite pass (523/523 at CS-CP07); Local Service 200/200 | pending | IN_PROGRESS |
