...
| 1 Session foundation | IN_PROGRESS | Domain, Application, schema 16, SQLite repository, Local Service CRUD, client, restart/idempotency/no-formal-write tests implemented. Source capture/refresh, round transaction and Provider remain. |
