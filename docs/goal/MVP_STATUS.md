...
runtime_checks_pending:
  - "V2 delete-Anchor review, finite-subtree and current-page Candidate one-at-a-time failure paths, Proposal reject/defer and process-fault, first-run/protocol and remaining recovery Desktop Gates"
active_risks:
