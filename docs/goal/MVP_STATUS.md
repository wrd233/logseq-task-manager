...
runtime_checks_pending:
  - "Proposal defer/dependency and process-fault plus remaining recovery Desktop Gates; finite-subtree exact truncation/unload engineering edges and V2-VIEW-001 are complete"
active_risks:
