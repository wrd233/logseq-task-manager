...
runtime_checks_pending:
  - "V2 delete-Anchor review, current-page Candidate one-at-a-time failure paths, Proposal reject/defer and process-fault, finite-subtree exact truncation/unload engineering edges, and remaining recovery Desktop Gates"
active_risks:
