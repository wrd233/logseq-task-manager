...
runtime_checks_pending:
  - "MiniProject HIGH reasoned-lifecycle interaction and remaining release/error-classification Gates; Project HIGH, Commit/Undo process-fault, Proposal defer/dependency and V2-VIEW-001 are complete"
active_risks:
