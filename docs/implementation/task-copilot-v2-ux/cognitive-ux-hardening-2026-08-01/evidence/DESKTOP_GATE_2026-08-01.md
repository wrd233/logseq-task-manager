...
> 环境：Logseq 0.10.15 / macOS / 插件 r11 build `b443d589b268`（源码 HEAD `45d8726` +
> 未提交的 select 术语修复）/ Local Service READY / schema 12 / 测试 Graph `logseq`。
...
- `tmp/runtime/cognitive-ux-hardening/current/01-now-light-1000.png`
...
- 自动化：Plugin 407/407、origin 9/9、scoped-outcome 4/4、typecheck/build、根级检查（提交前重跑）。
