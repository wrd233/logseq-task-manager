...
| UX-R12 | 状态翻译隐藏关键信息 | 结论过度压缩 | 恢复风险不可见 | P0-I 五问首屏已上线；P1-D System/Proposal/Recent Changes 已消费统一结论/依据/facts/unknown/provenance，技术状态折叠保留，Commit/Undo 资格未迁入叙述层；Object/Anchor/Now consumer 与 Desktop 待做 | MITIGATED |
