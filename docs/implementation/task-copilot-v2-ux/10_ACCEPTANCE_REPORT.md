...
- [ ] Block 标记不干扰阅读/编辑；
- [ ] Project/Task 重入有效；
- [ ] LLM 输出事实/推断/未知分离；机器 fact/action/provenance/risk/review 契约与
  server-owned Project recovery 路由自动 PASS，真实 Provider 语义与 Plugin consumer OPEN；
