...
| P1 | IN_PROGRESS_SHADOW_ONLY | P1-A/B pure model、detector、bounded repository、Plugin session runtime + P1-D deterministic narration contract automated PASS | 无用户可见 / 无 Desktop telemetry 声明 | 不得开放信号显示 |
| P2 | NOT_STARTED | — | — | — |
