...
| P1 | IN_PROGRESS_PARTIAL_UI | P1-A/B runtime shadow + P1-C dynamic Now count-only runtime + P1-D System/Proposal/Recent Changes consumer + P1-F Project reentry workspace automated PASS | Object/Anchor/Now narration、Page slot/Desktop 未验；Attention 仍无用户显现 | 不得开放信号显示 |
| P2 | NOT_STARTED | — | — | — |
