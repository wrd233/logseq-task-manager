...
| P2 | IN_PROGRESS_P2_AB_DONE_P2C_ALL_SOURCES_DONE_P2D_LIGHT_CONDITION_MEDIUM_HEAVY_CORE_DONE_P2E_READ_ONLY_PREVIEW | P2-A/B、P2-C、P2-D 三条核心链及 P2-E Application→Service→Plugin read-only preview automated PASS | P2-C 三来源与 P2-D 三条核心链有 Desktop；P2-E 无 Desktop | P2-D 仍 Partial；P2-E 只读预览 DONE、Provider/正式链/Desktop OPEN；P2-F～G OPEN |
