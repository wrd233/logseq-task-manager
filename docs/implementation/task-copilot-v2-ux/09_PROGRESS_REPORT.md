...
| P1 | IN_PROGRESS_SHADOW_ONLY | P1-A 纯模型 + bounded session shadow repository automated PASS；未展示、未接 runtime、UX-G008 OPEN |
...
2. 继续 P1-B 确定性 detector/merge/invalidation 的纯函数与 shadow telemetry，不开放前台；
