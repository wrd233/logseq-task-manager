...
| Recovery / Rebind / Restore / Migration | Rebind 受控选择主链已完成；纠错指引自动 Gate 不复活 missing/conflict 旧 Anchor；Restore 正常往返已完成；Migration 已完成 ledger、session-only scan、逐项 Review 与 PREVIEWED 计划创建 | CURRENT：Rebind `p2-g-07`～`12`；Restore `p2-g-13`～`19`；Migration scan `p2-g-20`～`25`、Review/Preview `p2-g-26`～`29` | Rebind 新成功态；Restore failure/Recovery；Migration 恢复点、Import/Verify/Activate/Undo |
