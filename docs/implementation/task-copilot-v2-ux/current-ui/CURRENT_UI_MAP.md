...
| Recovery / Rebind / Restore / Migration | Rebind 受控选择主链已完成；纠错指引自动 Gate 不复活 missing/conflict 旧 Anchor；Restore 正常往返已完成；Migration 已完成 ledger、session-only scan、逐项 Review、PREVIEWED 计划以及恢复点/Import/Verify/Undo 正常主链 | CURRENT：Rebind `p2-g-07`～`12`；Restore `p2-g-13`～`19`；Migration scan `p2-g-20`～`25`、Review/Preview `p2-g-26`～`29`、Import/Verify/Undo `p2-g-30`～`37` | Rebind 新成功态；Restore failure/Recovery；Migration Activate、失败/中断恢复、完成后退出日常 UI |
