...
P1-H session disposition live-service pass and Desktop open / P2-A adaptive MiniProject Grill + zero-loss preview live-provider pass / P2-B restructure Proposal Review + resilient Commit/inverse Undo executors automated + same-session Desktop UUID move/restore PASS; formal UI/full Desktop/Rebind open /
