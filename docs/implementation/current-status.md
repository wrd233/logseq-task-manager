...
- 自动检查：2026-07-20 `./scripts/check.sh` PASS，131 tests、145 rules、0 skipped；typecheck、lint、build、package/bootstrap/dist、边界与恢复演练全过；
...
1. 将已验证的离线 Restore 原语纳入 Service 停机、显式确认与重启后 Doctor 编排；
