...
- 自动检查：2026-07-22 根级 `./scripts/check.sh` 为 370 tests、145 rules、0 failed/skipped；全部 typecheck/lint/test/build、Plugin/边界检查与恢复演练 PASS；npm audit 既有 2 high / 1 critical 未用破坏性 `audit fix --force`；
