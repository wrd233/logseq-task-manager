...
P1-H session disposition live-service pass and Desktop open / P2-A adaptive MiniProject Grill + zero-loss preview live-provider pass / P2-B server-owned restructure Proposal Review UI automated /
