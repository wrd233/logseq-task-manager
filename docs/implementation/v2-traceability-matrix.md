...
| E2E-11 | V2 §68 | Focus/期限/阻碍/Waiting 可解释排序 | Focus 非状态；Waiting 安静；无分数 | query now work | Now Work UI | VM + Desktop | E | AUTOMATED_FOUNDATION | V2 纯投影与正式 UI 已证明 Focus 读取、近期 actionable、到期 Waiting、普通 Waiting 静默、三区域空隐藏和无分数；Focus mutation、期限字段、复杂阻碍排序与 Desktop 待完成 |
